...
Map<String,Integer> reservation = new UpcomingReservationReport((String) session.getAttribute("reportPeriod"),(Location) session.getAttribute("loc")).generateReport();
