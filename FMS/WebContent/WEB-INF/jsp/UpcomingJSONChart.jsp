...
Map<String,Double> reservationP = new UpcomingReservationReport((String) session.getAttribute("reportPeriod"),(Location) session.getAttribute("loc")).generatePercentageReport();
