...
public class UpcomingReservationReport {
	private List<Reservation> reservations;
	private String period;
	private Location loc;
	
	public UpcomingReservationReport() {
		
	}
	
	// Period --> DAILY, WEEKLY, MONTHLY, YEARLY
	public UpcomingReservationReport(String period, Location loc) {
		this.loc = loc;
		this.period = period;
	...
	public void setReservations() {
		this.reservations = new ReservationQuery().getFutureReservationsByLocation(loc.getLocationID());
	}
